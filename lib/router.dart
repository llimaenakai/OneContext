...
final router = GoRouter(
  initialLocation: '/add-user', // Set the initial location to login
  routes: <RouteBase>[
    GoRoute(
      path: '/login',
      name: 'login',
    ...
    GoRoute(
      path: '/add-user',
      name: 'addUser',
      builder: (BuildContext context, GoRouterState state) => const AddUserScreen(),
    ),
    GoRoute(
    ...
    GoRoute( // Example route for error screen, though GoRouter has errorBuilder
      path: '/error',
      name: 'error',
